...
export const Loader2 = ({ className = "", size = 16 }: IconProps) => (
...
export const Sparkles = ({ className = "", size = 16 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const LayoutGrid = ({ className = "", size = 16 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ArrowLeftRight = ({ className = "", size = 16 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const Info = ({ className = "", size = 16 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const Circle = ({ className = "", size = 16 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const Copy = ({ className = "", size = 16 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const Table = ({ className = "", size = 16 }: IconProps) => (
  <svg
    className={className}
    width={size}
    height={size}
    ...
    strokeWidth="2"
  >
    <path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v6m0 0v6m0-6h10m0 0v6a2 2 0 0 1-2 2H9m10-8H9m0 8v-6m0 6H5a2 2 0 0 1-2-2v-6m2 6h4" />
  </svg>
)
